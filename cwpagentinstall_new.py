...
if __name__=="__main__":
   ...
   if (len(sys.argv) < 5):
      print ("Insufficient number of arguments passed. Pass all 4 CWP API key parameters from 'Setting Page->API Keys' tab. Usage: python cwpagentinstall_new.py <Customer ID> <Domain ID> <Client Id> <Client Secret Key>")
      exit()
